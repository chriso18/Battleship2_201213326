...
public class Player {
	...
	public static void isStatsOpen()
	{
		...
		{	
			...
			Battleship.getestadisticas().getContentPane().add(Battleship.getStats());
			Battleship.getestadisticas().pack();
			Battleship.getestadisticas().repaint();
		}				
	}	
	...
	public void humanAttack(ActionEvent v)
	{
		...
		{				
			...
			if ((i==10)&&(j==10))
				JOptionPane.showMessageDialog(null,"Te Tardastes Demasiado!",
				" Perdistes tu Turno",JOptionPane.INFORMATION_MESSAGE);				
			Player.isStatsOpen();
			this.setMove(false);
			this.getTimer().stop();				
